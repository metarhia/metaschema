...
const List = category => items => items.map(
...
const Unique = (...fields) => {
  ...
  return new Unique(fields);
};

const Validate = fn => {
  class Validate {}
  return Object.setPrototypeOf(fn, Validate);
};

Object.assign(structs, {
  Enum, List, // structure decorators
  Many, Parent, Master, Include, // field decorators
  Dictionary, // category decorators
  Index, Unique, // index decorators
  Validate // validation function decorator
});
